...
public class TutorialPattern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fileWriteString="0.2"+","+"PatternTutorialStart,"+ AAHapticCommon.dateTime()+"\n";
        ...
        Button readyButton = findViewById(R.id.readyPattern);
        ...
        genButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                generatePresses++;
                writeAns("0.1.2","PatternInput","GenerateButton","PatternTutorial");
        ...
        dotButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                writeAns("0.1.2","patternInput",".","PatternTutorial");
                startDown=System.currentTimeMillis();
                ...
                new Thread(new TutorialPattern.ShortVib()).start();
            }
        });
        ...
        dashButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                vibrator.vibrate(10000);
                inputTV.setText(getPattern.convertPatternToText(getPattern.convertToDotDash(userCreatedPattern)));
                new Thread(new TutorialPattern.LongVib()).start();
            }
        });
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                writeAns("3.2", "final", getPattern.convertToDotDash(userCreatedPattern), "PatternTutorial");
                ...
                builder.setMessage("Required: " + getPattern.convertPatternToText(answerPattern.toString()) + "\nYou entered: " + getPattern.convertPatternToText(getPattern.convertToDotDash(userCreatedPattern)))
                        .setPositiveButton("Okay!", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Intent sameActivity = new Intent(TutorialPattern.this, TutorialPattern.class);
        ...
        readyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AAHapticCommon.patternConditionCount=0;
                getPattern.resetCounter();
                String fileWriteString="0.2"+","+"PatternTutorialEnd,"+ AAHapticCommon.dateTime()+"\n";
                AAHapticCommon.writeAnswerToFile(getApplicationContext(), fileWriteString);
                Intent sameActivity = new Intent(TutorialPattern.this, AAInputPattern.class);
                startActivity(sameActivity);
                finish();
        ...
        resetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inputTV.setText("");
                writeAns("0.1.2","patternInput","reset","PatternTutorial");
