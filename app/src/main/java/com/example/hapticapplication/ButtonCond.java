...
public class ButtonCond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String option1Pattern = getPattern.threePatternOption(3);
        String option2Pattern = getPattern.threePatternOption(5);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (randSettings.getFirstPage() == 3) {
                    ...
                    if (nextPageVib == 4) {
                        Intent fourActivityIntent = new Intent(ButtonCond.this, FourButtonCond.class);
                    ...
                    if (randSettings.getFirstActivity().matches("Button")) {
                        ...
                        if (randSettings.getFirstPage() == 3) {
                            if (nextActivity.matches("Pattern")) {
                                Intent intentPattern = new Intent(ButtonCond.this, ThreePatternCond.class);
                                startActivity(intentPattern);
                            } else if (nextActivity.matches("Gesture")) {
                                Intent intentGesture = new Intent(ButtonCond.this, ThreeGestureCond.class);
                                startActivity(intentGesture);
                            }
                        } else if (randSettings.getFirstPage() == 4) {
                            if (nextActivity.matches("Pattern")) {
                                Intent intentPattern = new Intent(ButtonCond.this, FourPatternCond.class);
                                startActivity(intentPattern);
                            } else if (nextActivity.matches("Gesture")) {
                                Intent intentGesture = new Intent(ButtonCond.this, FourGestureCond.class);
                                startActivity(intentGesture);
                            }
                        } else if (randSettings.getFirstPage() == 5) {
                            if (nextActivity.matches("Pattern")) {
                                Intent intentPattern = new Intent(ButtonCond.this, FivePatternCond.class);
                                startActivity(intentPattern);
                            } else if (nextActivity.matches("Gesture")) {
                                Intent intentGesture = new Intent(ButtonCond.this, FiveGestureCond.class);
                                startActivity(intentGesture);
                            }
                        }
                    }
